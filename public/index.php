...
use App\Controllers\PersonalizacionController;
...
$router->get('/personalizacion', [PersonalizacionController::class, 'index'], true);
$router->post('/personalizacion/logo', [PersonalizacionController::class, 'actualizarLogo'], true);
$router->post('/personalizacion/logo/restaurar', [PersonalizacionController::class, 'restaurarLogo'], true);
$router->post('/personalizacion/fondo', [PersonalizacionController::class, 'actualizarFondo'], true);
$router->post('/personalizacion/fondo/restaurar', [PersonalizacionController::class, 'restaurarFondo'], true);
